...
export default function NotFound() {
  return (
    <section
   className="relative z-10 flex items-center justify-center min-h-screen py-10 overflow-hidden bg-white dark:bg-dark"
   >
   <div className="container mx-auto">
      <div className="mx-auto w-full max-w-[570px] text-center">
         <span
            className="text-[100px] font-extrabold text-[#933DE6] sm:text-[150px]"
            >
         404
         </span>
         <h2
            className="mb-3 text-2xl font-bold text-dark dark:text-white sm:text-4xl"
            >
            Sorry, the page can&apost be found
         </h2>
         <p
            className="mx-auto mb-8 max-w-[490px] text-base dark:text-dark-6 text-body-color"
            >
         ...
         <Link
            href="/"
            className="px-8 py-3 text-base font-medium text-white rounded bg-[#933DE6] hover:bg-opacity-90"
            >
         Back to homepage
         </Link>
      </div>
      ...
      <svg
         ...
         <defs>
            ...
            <linearGradient
               ...
               >
               <stop stopColor="#3056D3" stopOpacity="0" />
               <stop offset="1" stopColor="#3056D3" />
            </linearGradient>
            <linearGradient
