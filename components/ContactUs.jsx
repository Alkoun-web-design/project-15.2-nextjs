                        ...
                        <div key={index} className="w-full px-4">
                          <div className="mb-7">
                            <textarea
                              ...
                              rows="6"
                              className="w-full resize-none border border-stroke bg-transparent px-5 py-[17px] text-body-color outline-none focus:border-primary dark:border-dark-3 dark:text-dark-6 dark:focus:border-primary"
                            ></textarea>
                          </div>
                        </div>
                      ) : (
                        <div key={index} className="w-full px-4 md:w-1/2">
                          <div className="mb-7">
                            <input
                              type={item.type}
                              placeholder={item.placeholder}
                              className="w-full border border-stroke bg-transparent px-5 py-[17px] text-body-color outline-none focus:border-primary dark:border-dark-3 dark:text-dark-6 dark:focus:border-primary"
                            />
                          </div>
                        </div>
                      ),
