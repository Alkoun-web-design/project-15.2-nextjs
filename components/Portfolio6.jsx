        ...
        >
          <div className="w-full">
            <div className="relative ml-auto w-full max-w-[330px] bg-white dark:bg-dark-2 py-[56px] px-8 sm:px-10">
              <span className="bg-[#f33f3f] absolute right-0 top-0 rounded-bl-2xl p-4 text-2xl font-semibold text-white">
                {number}
              </span>
              ...
              <a
                href={link}
                className="text-dark dark:text-white hover:text-[#f33f3f] inline-flex items-center text-sm font-medium"
              >
                {button}
                <span className="ml-2">
                  <svg
