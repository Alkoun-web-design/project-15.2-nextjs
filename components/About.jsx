// import aboutImage from "about/about-08/image-01.jpg";
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="relative mb-12 lg:mb-0">
                <div className="mx-auto max-w-[430px] rounded-tl-[50px] sm:rounded-tl-[70px]">
                  <Image
                    src="about/about-08/image-01.jpg"
                    alt="about image"
                    className="w-full rounded-tl-[50px] sm:rounded-tl-[70px]"
                  />
                </div>
                <div className="absolute bottom-0 right-0 z-10 max-w-[320px] overflow-hidden rounded-tr-[50px] bg-[#f33f3f] px-6 py-10 text-xl font-bold text-white sm:px-10 sm:text-2xl">
            ...
            <div className="w-full px-4 lg:w-1/2 2xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                {serviceItems.map((item, index) => (
                  ...
                  >
                    <span className="w-full max-w-[45px] pr-4 text-2xl font-bold text-[#f33f3f]">
