...
// import PortfolioImage7ps from "@public/7ps.webp";
// import PortfolioImageAds from  "@public/ads.webp";
// import PortfolioImageContentCreation from "@public/content-creation.webp";
// import PortfolioImageContentCreationP2 from "@public/content-creation-p2.webp";
// import PortfolioImageAnalysisTools from "tools-of-analysis.webp";
...
const Portfolio4 = () => {
  ...
  return (
    <>
      <section id="portfolio" className="py-20 lg:py-[120px] dark:bg-dark">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                <span className="text-[#f33f3f] mb-2 block text-lg font-semibold">
                  My Portfolio
                </span>
            ...
            <div className="relative w-full pb-12 md:w-11/12 md:pb-0 lg:w-10/12 xl:w-8/12">
              <Swiper slidesPerView={1} ref={sliderRef}>
                <SwiperSlide>
                  <PortfolioCard
                    ...
                    title="7 Ps"
                    details="A presentation on the analysis of the 7Ps regarding 'Primos American Pizza', a pizza chain in Egypt's Cairo and Alexandria, with a branch in Suadi Arabia, I conclude with recommendations on promoting and marketing."
                    link="https://www.canva.com/design/DAGbV1ll1TM/82VxaIuTewh6YZ1MwMjnLA/view"
                    button="View Details"
                    image="7ps.webp"
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <PortfolioCard
                    subtitle="Presentation"
                    title="Tools of Analysis"
                    details="Presentation for the Magdi Yacoub Foundation's facebbook page and content. An analysis of key facebook metrics regarding social media posts and interactions."
                    link="https://www.canva.com/design/DAGcYqju_6c/kpGuv7Rh5e0OG4L5rDkfUw/view"
                    button="View Details"
                    image="tools-of-analysis.webp"
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <PortfolioCard
                    ...
                    details="A presentation for El Profesorito, the first specialized institute for learning Spanish in a unique and engaging way. Emphasis is on brand awareness, audience engagement and limited discounts and sales."
                    link="https://www.canva.com/design/DAGdqb9YS1Y/6pkT6OT2Vgq_czizJlET-A/view"
                    button="View Details"
                ...
                <SwiperSlide>
                  <PortfolioCard
                    subtitle="Presentation"
                    title="Content Creation P2"
                    details="A presentation for Sladoska, a premium chocolate brand in Egypt that specializes in chocolate bouquets, fruit dipped in chocolate, and other luxurious treats. Emphasis is on brand awareness, audience engagement and limited discounts and sales."
                    link="https://www.canva.com/design/DAGe_66jD0Q/mQZHMv8wYbrk8R1A2qYDEg/view"
                    button="View Details"
                    image="content-creation-p2.webp"
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <PortfolioCard
                    subtitle="Presentation"
                    title="Ads"
                    details="A presentation on Facebook ads and a video link to choosing the right campaign objectives, name, template, performance goals, budget and schedule. Choosing the right target location and audience, platform placements, and finally the ad settings and name."
                    link="https://www.canva.com/design/DAGfjkxrM8s/govrVpN3EBSWhMhnICXPqQ/view"
                    button="View Details"
                    image="ads.webp"
                  />
                </SwiperSlide>
              ...
              <div>
                <div className="prev-arrow cursor-pointer" onClick={handlePrev}>
                  <button className="text-body-color dark:text-dark-6 drop-shadow-portfolio dark:drop-shadow-none absolute left-[30%] top-full flex h-[54px] w-[54px] items-center justify-center rounded-full bg-white dark:bg-dark-2 transition-all hover:bg-[#f33f3f] hover:text-white md:-left-12 md:top-1/2 lg:-left-16">
                    <svg
                      width={22}
                      height={22}
                      viewBox="0 0 22 22"
                ...
                <div className="next-arrow cursor-pointer" onClick={handleNext}>
                  <button className="text-body-color dark:text-dark-6 drop-shadow-portfolio dark:drop-shadow-none absolute top-full left-auto right-[30%] flex h-[54px] w-[54px] items-center justify-center rounded-full bg-white dark:bg-dark-2 transition-all hover:bg-[#f33f3f] hover:text-white md:top-1/2 md:-right-12 lg:-right-16">
                    <svg
                      width={22}
                      height={22}
                      viewBox="0 0 22 22"
  ...
  return (
    <div className="relative w-full items-stretch overflow-hidden rounded-md md:flex">
      <div className="w-full">
        <div className="bg-[#f33f3f] xs:px-8 py-12 px-5 md:px-11 xl:py-20">
